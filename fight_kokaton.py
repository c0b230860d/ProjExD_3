...
class Beam:
    ...
    def __init__(self, bird:"Bird"):
        ...
        self.img = pg.transform(self.img, math.degrees(self.kakudo), 1.0)
        self.rct.width = self.rct.centerx + (bird.rct.right - bird.rct.left) * (self.vx)/5
        self.rct.height =  self.rct.centery + (bird.rct.bottom - bird.rct.top) * (self.vy)/5
